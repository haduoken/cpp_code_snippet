...
PclScanPtr transformScan(PclScanPtr &in, EigenPose &trans, string distortion = "none");

bool SavePngYaml(string map_name, string map_dir, PclMapPtr map, float min_height, float max_height);